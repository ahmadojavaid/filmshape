...
class TeamTabDetails extends StatefulWidget {
  final List<ProjectRoleCallss> roleCalls;

  TeamTabDetails({this.roleCalls});

  @override
  _MenuHomeState createState() => _MenuHomeState();
}

class _MenuHomeState extends State<TeamTabDetails> {
                        ...
                        new Container(
                            ...
                            child: ClipOval(
                              child: getCachedNetworkImage(
                                  url:
                                      "${APIs.imageBaseUrl}${like.assignee.thumbnailUrl}",
                                  fit: BoxFit.cover),
                            )),
                        new SizedBox(
                          width: 5.0,
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    new Text(
                                      like.role != null &&
                                              like.role.category != null
                                          ? " (${like.role.category.name})"
                                          : "",
                                      style: new TextStyle(
                                          color:
